 ...
 * @author atomar
 */
public class Cappuccino extends CmmProgram{
   ...
   private CmmProgram cmm;
    ...
    public void start() {
      ...
      env.setCoffeeType(this.name.toString());
        env.setPowerLED(0);
        env.setTypeLED(1);
        env.setGrindingTime(6);
        env.setTemperature(120);
        env.holdTemperature(6);
        env.wait(15);
        env.setPowerLED(1);
